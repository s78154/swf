...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
   ...
   * @ordered
   */
  protected EList<PrologDsl> model;
   ...
   * @generated
   */
  public EList<PrologDsl> getModel()
  {
    if (model == null)
    {
      model = new EObjectContainmentEList<PrologDsl>(PrologDsl.class, this, S78154S78236Package.MODEL__MODEL);
    }
    return model;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case S78154S78236Package.MODEL__MODEL:
        getModel().clear();
        getModel().addAll((Collection<? extends PrologDsl>)newValue);
        return;
    }
